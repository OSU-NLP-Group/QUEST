...
from react_agent_ref_gen import MultiTurnReactAgent
import time
import math
            ...
            with open(data_filepath, "r", encoding="utf-8") as f:
                ...
                for item in items:
                    ...
                    if "answer" not in item:
                        item["answer"] = ""
                    if " All information should be verifiable through reliable sources. All information should be supported by public or official URLs with inline citations." not in item["question"]:
                        item["question"] +=" All information should be verifiable through reliable sources. All information should be supported by public or official URLs with inline citations."
        else:
