...
class CheckpointConfig(BaseConfig):
    ...
    Args:
        ...
        mbridge_config (dict[str, Any]): Optional extra kwargs forwarded to mbridge save APIs when supported.
        save_distributed_optimizer_parameter_state (bool): Whether to separately save/load Megatron distributed
            optimizer parameter state such as Adam moments when the optimizer state dict does not include them.
    """
    ...
    save_distributed_optimizer_parameter_state: bool = False
