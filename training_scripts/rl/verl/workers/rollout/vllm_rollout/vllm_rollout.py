...
def _get_vllm_server_actor_name(replica_rank: int, node_rank: int) -> str:
    return f"vllm_server_{_get_job_id_suffix()}_{replica_rank}_{node_rank}"
...
class ServerAdapter(BaseRollout):
    ...
    async def _execute_method(
        ...
        if self.server_handle is None:
            self.server_handle = ray.get_actor(_get_vllm_server_actor_name(self.replica_rank, self.node_rank))
