...
class FullyAsyncTaskRunner:
    ...
    def _initialize_components(self, config) -> None:
        ...
        ray.get(self.components["trainer"].sync_rollout_with_current_version.remote(validate=val_before_train))
        ray.get(self.components["trainer"]._wait_last_rollouter_update.remote())
