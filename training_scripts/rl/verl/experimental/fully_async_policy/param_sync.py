...
class ParameterSynchronizer:
    ...
    def sync_weights(self, version, validate=False, global_steps=0, use_trainer_do_validate=False):
        ...
        print(
            "[ParameterSynchronizer] begin rollout weight sync. "
            f"rollout_name={rollout_name}, use_checkpoint_engine={use_checkpoint_engine}, version={version}"
        )
        ...
        # Update MQ version only after rollout has received the new weights.
