#!/usr/bin/env python3
"""
Merge scholar SQLite shards and build the FAISS index in one pass.
...
def load_config_paths():
    """Read scholar cache_dir, cache_file, shards, and faiss_embedding_model from config/tools.yaml."""
    import os
