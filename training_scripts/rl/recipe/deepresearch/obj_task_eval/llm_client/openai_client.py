"""
obj_task_eval/llm_client/openai_client.py
...
def _resolve_openai_or_azure_client_kwargs():
...
class OpenAIClient:
    ...
    def __init__(self) -> None:
        client_kwargs = _resolve_openai_or_azure_client_kwargs()
        if client_kwargs["client_cls"] == "azure":
            from openai import AzureOpenAI

            self.client = AzureOpenAI(
                api_key=client_kwargs["api_key"],
                azure_endpoint=client_kwargs["azure_endpoint"],
                api_version=client_kwargs["api_version"],
            )
        else:
            self.client = OpenAI(api_key=client_kwargs["api_key"])
...
class AsyncOpenAIClient:
    ...
    def __init__(self) -> None:
        ...
        if client_kwargs["client_cls"] == "azure":
            ...
            self.client = AsyncOpenAI(api_key=client_kwargs["api_key"])
