...
export DATASET="${DATASET:-${SCRIPT_DIR}/../evaluation/drbench/deepresearch_bench_questions.jsonl}"
export OUTPUT_PATH="${OUTPUT_PATH:-${SCRIPT_DIR}/outputs/drbench/results}"
export TASK_LOG_DIR="${TASK_LOG_DIR:-${SCRIPT_DIR}/outputs/drbench/memory_logs}"
