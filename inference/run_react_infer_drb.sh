...
export DATASET=/fs/scratch/PAS1576/jianxie/DeepResearch/evaluation/datasets/drbench/deepresearch_bench_questions.jsonl
export OUTPUT_PATH=/fs/scratch/PAS1576/jianxie/DeepResearch/evaluation/datasets/drbench/a3b-results/qwen3-moe-rl-45steps-16k-output-80k-memory-200turns/results
export TASK_LOG_DIR=/fs/scratch/PAS1576/jianxie/DeepResearch/evaluation/datasets/drbench/a3b-results/qwen3-moe-rl-45steps-16k-output-80k-memory-200turns/memory_logs
...
export MEMORY_THRESHOLD="${MEMORY_THRESHOLD:-16000}"
