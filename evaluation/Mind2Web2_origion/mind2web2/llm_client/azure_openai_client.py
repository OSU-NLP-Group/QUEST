...
import backoff
from openai import BadRequestError, APIConnectionError, RateLimitError, InternalServerError, APITimeoutError


logging.getLogger("httpx").setLevel(logging.WARNING)
logger = logging.getLogger(__name__)
MAX_RETRY_TRIES = int(os.getenv("OPENAI_RETRY_MAX_TRIES", "3"))
...
@backoff.on_exception(
    backoff.expo,
    (BadRequestError, APIConnectionError, RateLimitError, InternalServerError, APITimeoutError),
