...
5.  **Language Neutrality**: The choice of language (Chinese or English) does not affect the evaluation. Both Chinese and English outputs are accepted. Weights should be set based on content quality.
...
6.  **Language Neutrality**: The choice of language (Chinese or English) does not affect the evaluation. Both Chinese and English outputs are accepted. Criteria should be set based on content quality.
</instruction>
